...
$uid= '1591';
$signKey = 'D6112D5E02329B9E51D6A3BAF932A5BF';
$gateway = 'http://www.mile101.me/payapi/Index/payindex';
...
curl_close($ch);
echo "米乐支付宝支付提交URL:$gateway,提交参数:".json_encode($data,320).",接收响应:".$response;
